...
def resid(params):
	...
	modela1=modfunc(params['meana1'].value,params['covara1'].value,params['na'].value,xa1)
	modela2=modfunc(params['meana2'].value,params['covara2'].value,params['na'].value,xa2)
	modela3=modfunc(params['meana3'].value,params['covara3'].value,params['na'].value,xa3)
	modela4=modfunc(params['meana4'].value,params['covara4'].value,params['na'].value,xa4)
...
fnca1=(modfunc(out.params['meana1'].value,out.params['covara1'].value,out.params['na'].value,xval1))
fnca2=(modfunc(out.params['meana2'].value,out.params['covara2'].value,out.params['na'].value,xval2))
fnca3=(modfunc(out.params['meana3'].value,out.params['covara3'].value,out.params['na'].value,xval3))
fnca4=(modfunc(out.params['meana4'].value,out.params['covara4'].value,out.params['na'].value,xval4))
...
plt.savefig("fig-mechanistic-Hill-all-diff-n",format='eps')
